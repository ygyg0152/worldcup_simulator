// FIFA 2026 공식 3위팀 배분 테이블 (Annex C, 495가지 경우)
// 출처: en.wikipedia.org/wiki/Template:2026_FIFA_World_Cup_third-place_table
// key: 8개 진출 조 알파벳 정렬 문자열 → value: 8개 슬롯에 배정되는 조 문자 배열
